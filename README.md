[![Build Status](https://dev.azure.com/StoicFinch/Pipeline%20Demo/_apis/build/status/zoleitschuk.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/StoicFinch/Pipeline%20Demo/_build/latest?definitionId=1&branchName=master)
